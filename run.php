...
///////////////////////////////////
echo "".PHP_EOL;
echo "       __    YOOK! TEMBUS TARGET YOOK!".PHP_EOL;
echo "      /  \   ~~|~~ ".PHP_EOL;
echo "     (|00|)    |".PHP_EOL;
echo "      (==)  --/".PHP_EOL;
echo "    ___||___  ".PHP_EOL;
echo "   / _ .. _ \ ".PHP_EOL;
echo "  //  |  |  \\ Indomaret Pointku V.2.1 (SPECIAL OTP)".PHP_EOL;
echo " //   |  |   \\ CREATED BY ASHA RIZKI".PHP_EOL;
echo " ||  / /\ \  || ".PHP_EOL;
echo "_|| _| || |_ ||_  -ASHA RIZKI-".PHP_EOL;
echo "\|||___||___|||/ ".PHP_EOL;
echo "".PHP_EOL;
echo "".PHP_EOL;
// goto pin_asu;
...
if ($cekpin['data'] !== true){
    ...
    $header_token = [
        ...
        kodereff:
        echo "| Masukan Kode REFF TOKO (contoh: TMUW): ";
        $inputan = fopen("php://stdin","r");
